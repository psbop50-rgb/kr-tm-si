...
const Activate_Shamel = () => {
  ...
  const companies = comprehensiveCompanies;
  ...
  const handleVisa = async (idx) => {
    ...
    try {
      if (parsed._id) {
        await axios.post(`${api_route}/company/${parsed._id}`, { companyData: company });
      }
    } catch {
        ...
        <div className="w-full   mx-auto px-4">
          ...
          <div className="bg-[#f97316] flex flex-col gap-y-3 rounded-md text-center py-4 px-2 text-white   mt-6 mb-4">
            <span className="text-xl font-bold">
              {t("activateShamel.heroTitle")}
            </span>
            <span className="text-sm">{t("activateShamel.heroSubtitle")}</span>
          </div>
              ...
              return (
                ...
                >
                  ...
                  <h6 className="text-sm font-bold text-gray-800 mb-3">
                    {t("activateShamel.comprehensiveBenefits")}
                  </h6>
                    ...
                    <div className="flex justify-between">
                      <div className="flex  items-start">
                        ...
                        <span className="flex-1 pr-2 flex flex-wrap">
                          {t("activateShamel.fullCoverage")}
                          <strong>{t("activateShamel.allRisks")}</strong>
                        </span>
                      </div>
